            ...
            <div class="login_wrapper">
                <div class="animate form login_form">
                    ...
                    <section class="login_content">
                        <form action="action/login.php" method="post" class="formu_login">
                            ...
                            <div class="separator">
                                ...
                                <br />
                                <div>
                                    <h1><i class="fa fa-ticket"></i> ShowGo!</h1>
                                    <p> El soporte es autoria de Seed Development Corporation. Privacidad y Términos por ShowGo</p>
                                </div>
                            </div>
