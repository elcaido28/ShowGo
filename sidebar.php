            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    <li class="<?php if(isset($active1)){echo $active1;}?>">
                        <a href="inicio.php"><i class="fas fa-user-tie fa-lg "> </i> Perfil</a>
                        <!-- <i class="fa fa-dashboard"></i> -->
                    </li>

                    <li class="<?php if(isset($active2)){echo $active2;}?>">
                      <a href="proyectos.php"><i class="fa fa-list-alt"> </i> Eventos</a>
                        <!-- <a href="tickets.php"><i class="fa fa-ticket"></i> Tickets</a> -->
                    </li>

                    <li class="<?php if(isset($active3)){echo $active3;}?>">
                        <a href="tickets.php"><i class="fa fa-align-left"> </i> Detallar Evento</a>
                    </li>

                    <li class="<?php if(isset($active4)){echo $active4;}?>">
                        <a href="categories.php"><i class="fas fa-chart-line fa-lg "> </i> Seguimiento Del Evento</a>
                    </li>

                    <li class="<?php if(isset($active4)){echo $active4;}?>">
                        <a href="categories.php"><i class="fas fa-bullhorn fa-lg "> </i> Gestión Pubicitaria</a>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="">
                        ...
                        <ul class="dropdown-menu dropdown-usermenu pull-right">
                            <li><a href="inicio.php"><i class="fa fa-user"></i> Mi cuenta</a></li>
